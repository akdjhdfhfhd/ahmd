...
chsource = Redis:get(Fast..'chsource') or "SOURCEVEGA"
devsource = Redis:get(Fast..'devsource') or "KIMMY50"
function var(value)  
...
xname =  (Redis:get(Fast.."Name:Bot") or "فيجا") 
...
local UserId_Info = bot.searchPublicChat("KIMMY50")
...
local TestText = "  ❲ 𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼𓆪✭𓂁 ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ⌯⎖᳒𝘿𝙀𝙑⌯⤹𝐊 𝐈᳔ 𝗠 𝗠 𝗬⤸► ◞', url = "https://KIMMY50"}
},
}
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼𓆪✭𓂁 ❳', url = "https://t.me/KIMMY50"}
},
{
{text = '❲ ⁨𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼𓆪✭𓂁 ❳', url = "https://t.me/SOURCEVEGA"},
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'حماصه' or text == 'مطور سورس' or text == 'مرات كيمي' then  
local UserId_Info = bot.searchPublicChat("H_U_SD")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = ' ꪔY υ᥉ᥱᖇ', url = "https://t.me/H_U_SD"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج فيجا ❳', url = "https://t.me/KIMMY50"}
},
{
{text = '❲ ⁨𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼 ❳', url = "https://t.me/SOURCEVEGA"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'كيمي' or text == 'المبرمج' then  
local UserId_Info = bot.searchPublicChat("KIMMY50")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼◞◞˼⁩ ,❳\nᥫ᭡\n ✭ *ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n✭  *ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ِ𝙙𝙀𝙑 𝐊 𝐈᳔ 𝗠 𝗠 𝗬  .', url = 't.me/KIMMY50'}, 
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "فيجا")
if text then
...
if text == 'السورس' or text == 'سورس' or text == 'فيجا' or text == 'يا سورس' or text == 'فينيميمبننجا' then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '◜ ⎖᳒𝘿𝙀𝙑⌯⤹𝐊 𝐈᳔ 𝗠 𝗠 𝗬⤸►◞', url = 't.me/'..devsource}, 
},
{
{text = '◜𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐆𝐀⚡️◞', url = 'http://t.me/'..chsource..''}, 
},
{
...
⌯━─━─𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼─━─━⌯
★ [𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼](https://t.me/SOURCEVEGA) 
★ [𝙈𝘼𝙆𝙀𝙍 𝙑𝙀𝙂𝘼](https://t.me/vegamarket_bot) 
★ [𝐊 𝐈᳔ 𝗠 𝗠 𝗬](https://t.me/KIMMY50) 
★ [𝙃𝙖𝙈𝙖𝙎𝙖](https://t.me/H_U_SD) 
⌯━─━─𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼─━─━⌯
⍟ 𝚆𝙴𝙻𝙲𝙾𝙼 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙴𝙶𝙰
⍟ [𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼](https://t.me/SOURCEVEGA) 
...
photo = "https://t.me/sourcevega2/16"
...
{
{text = '☢️ › إضغط هنا لتنصيب بوتك', url = 't.me/vegamarket_bot?start'}
},
{
{text = 'اضف البوت الي مجموعتك✅', url = 't.me/'..UserBot..'?startgroup=new'}
},
...
if text == (Redis:get(Fast.."Name:Bot") or "فيجا") then
if Redis:get(Fast.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(Fast.."Name:Bot") or "فيجا")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني",
"ثانيه واحده بسلك رقم واحده",
"انا مش فاضي فيجا مكاني اهو",
...
local photo = bot.getUserProfilePhotos(Fast)
local CmdStart = '*\n⚡️ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "فيجا")..
...
if not msg.Asasy then 
if not Redis:get(Fast.."Start:Bot") then
local CmdStart = '*\n ✭ ⋮ أهلا بك في بوت '..(Redis:get(Fast.."Name:Bot") or "فيجا")..
...
data = {
{
{text = '« كيمي»',type = 'text'},{text = '«سورس»', type = 'text'},
},
{
{text = '«الغاء الامر»',type = 'text'},
},
...
if text == 'مبرمج السورس ✭' or text == 'مبرمج السورس' or text == 'كيمي' then  
local UserId_Info = bot.searchPublicChat("KIMMY50")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼◞ ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑 𝐊 𝐈᳔ 𝗠 𝗠 𝗬 ❳', url = "https://t.me/KIMMY50"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج كيمي ', url = "https://t.me/KIMMY50"}
},
{
{text = '◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙑𝙀𝙂𝘼◞', url = "https://t.me/SOURCEVEGA"},
},
...
if text == 'سورس ✭' or text == 'سورس' or text == 'يا سورس' or text == 'source' or text == 'فيجا' then
photo = "https://t.me/sourcevega2/16"
local T =[[
